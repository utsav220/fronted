...
const Dashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 p-6">
      ...
      <div className="w-1/3 bg-white p-6 shadow-lg rounded-xl flex flex-col border border-gray-200">
  
  {/* Title & Analyze Button in One Line */}
  ...
  <textarea
    className="w-full p-3 h-90 border rounded-lg mb-4 focus:ring focus:ring-blue-300"
    placeholder="Paste the Job description here..."
    value={jobDescription}
    onChange={(e) => setJobDescription(e.target.value)}
  />
        <h2 className="text-lg font-semibold mt-1 mb-2 text-gray-700">Attach Resume</h2>
        <input 
          type="file" 
        ...
        <h2 className="text-lg font-semibold mt-1 mb-2 text-gray-700">Attach Notes</h2>
        <textarea
        ...
        {[
          ...
          { label: "Additional Areas", state: showAdditional, setter: setShowAdditional },
      ...
      {/* Right Panel */}
      <div 
        className="w-2/3 bg-white p-6 shadow-lg rounded-xl ml-6 flex flex-col border border-gray-200" 
      ...
      >
        ...
        <div className="p-3 bg-white rounded-b-xl flex items-center border-t">
          ...
          <button className="ml-2 bg-gray-200 border border-gray-600 text-black p-2 rounded-lg">B</button>
          <button className="ml-2 bg-gray-200 border border-gray-600 text-black p-2 rounded-lg">I</button>
          <button className="ml-2 bg-gray-200 border border-gray-600 text-black p-2 rounded-lg">E</button>
        </div>
      </div>
    </div>
  );
